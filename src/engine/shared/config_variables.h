...
MACRO_CONFIG_INT(ClFakeSuper, cl_fake_super, 0, 0, 1, CFGFLAG_CLIENT, "Enable fake super mode (local only, ignores freeze visually)")
MACRO_CONFIG_INT(ClDrawMode, cl_draw_mode, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable screen drawing mode")
MACRO_CONFIG_INT(ClDrawThickness, cl_draw_thickness, 2, 1, 10, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Drawing line thickness")
MACRO_CONFIG_COL(ClDrawColor, cl_draw_color, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Drawing color")
...
MACRO_CONFIG_STR(SvName, sv_name, 128, "5years Server", CFGFLAG_SERVER, "Server name")
